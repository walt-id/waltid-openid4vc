...
data class SupportedVPFormat(
  ...
  companion object: JsonDataObjectFactory<SupportedVPFormat>() {
    override fun fromJSON(jsonObject: JsonObject) = Json.decodeFromJsonElement(SupportedVPFormatSerializer, jsonObject)
  }
}
...
object SupportedVPFormatMapSerializer: KSerializer<Map<CredentialFormat, SupportedVPFormat>> {
  ...
  override fun serialize(encoder: Encoder, value: Map<CredentialFormat, SupportedVPFormat>) = internalSerializer.serialize(encoder, value)
}
