...
open class OpenIDProviderMetadata(
  ...
  @EncodeDefault @SerialName(GRANT_TYPES_SUPPORTED) val grantTypesSupported: Set<String> = setOf(GrantType.authorization_code.name, GrantType.pre_authorized_code.name),
