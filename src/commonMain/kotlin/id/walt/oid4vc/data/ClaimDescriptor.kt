...
data class ClaimDescriptor(
  ...
  val nestedClaims: Map<String, ClaimDescriptor> = customParameters.filterValues { it is JsonObject }
    .mapValues { ClaimDescriptor.fromJSON(it.value.jsonObject) }
  ...
  companion object: JsonDataObjectFactory<ClaimDescriptor>() {
    override fun fromJSON(jsonObject: JsonObject) = Json.decodeFromJsonElement(ClaimDescriptorSerializer, jsonObject)
  }
}
...
object ClaimDescriptorMapSerializer: KSerializer<Map<String, ClaimDescriptor>> {
  ...
  override fun serialize(encoder: Encoder, value: Map<String, ClaimDescriptor>) = internalSerializer.serialize(encoder, value)
}

object ClaimDescriptorNamespacedMapSerializer: KSerializer<Map<String, Map<String, ClaimDescriptor>>> {
  private val internalSerializer = MapSerializer(String.serializer(), MapSerializer(String.serializer(), ClaimDescriptorSerializer))
  override val descriptor: SerialDescriptor = internalSerializer.descriptor
  override fun deserialize(decoder: Decoder): Map<String, Map<String, ClaimDescriptor>> = internalSerializer.deserialize(decoder)
  override fun serialize(encoder: Encoder, value: Map<String, Map<String, ClaimDescriptor>>) = internalSerializer.serialize(encoder, value)
}
