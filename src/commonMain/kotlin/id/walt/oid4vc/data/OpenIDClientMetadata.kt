...
data class OpenIDClientMetadata(
  ...
  companion object: JsonDataObjectFactory<OpenIDClientMetadata>() {
    override fun fromJSON(jsonObject: JsonObject) = Json.decodeFromJsonElement(OpenIDClientMetadataSerializer, jsonObject)
  }
}

object OpenIDClientMetadataSerializer: JsonDataObjectSerializer<OpenIDClientMetadata>(OpenIDClientMetadata.serializer())