...
data class VCFormatDefinition(
    ...
    companion object: JsonDataObjectFactory<VCFormatDefinition>() {
        override fun fromJSON(jsonObject: JsonObject) = Json.decodeFromJsonElement(VCFormatDefinitionSerializer, jsonObject)
    }
}
...
object VCFormatMapSerializer: KSerializer<Map<VCFormat, VCFormatDefinition>> {
    ...
    override fun serialize(encoder: Encoder, value: Map<VCFormat, VCFormatDefinition>) = internalSerializer.serialize(encoder, value)
}